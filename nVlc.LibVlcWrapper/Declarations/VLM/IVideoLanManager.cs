...
namespace nVlc.LibVlcWrapper.Declarations.VLM
{
    /// <summary>
    /// 
    /// </summary>
    public interface IVideoLanManager : IDisposable
    {
        ...
        void AddBroadcast(string name, string input, string output, IEnumerable<string> options, bool bEnabled, bool bLoop);
        ...
        void AddVod(string name, string input, IEnumerable<string> options, bool bEnabled, string mux);
