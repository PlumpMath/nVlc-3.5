...
using nVlc.LibVlcWrapper.Declarations.Filters;
using nVlc.LibVlcWrapper.Declarations.Players;
using nVlc.LibVlcWrapper.Implementation.Filters;
using nVlc.LibVlcWrapper.Implementation.Utils;
using nVlc.LibVlcWrapper;

namespace nVlc.LibVlcWrapper.Implementation.Players
{
